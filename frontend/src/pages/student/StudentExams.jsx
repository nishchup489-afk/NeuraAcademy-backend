...
export default function StudentExams() {
  ...
  useEffect(() => {
    const fetchExams = async () => {
        try {
          const examsRes = await api.get(`/student/courses/${courseId}/exams`);
          setExams(examsRes.data.exams || []);
          setAttempts(examsRes.data.attempts || []);
        } catch (error) {
  ...
  const handleViewResult = (attemptId) => {
    navigate(`/student/exams/attempts/${attemptId}/result`);
  };
